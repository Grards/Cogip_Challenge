...
class Contact {
    ...
    public function getLatestContacts($limit) {
        ...
        $query = "SELECT id, name, company_id, email, phone, created_at, updated_at FROM contacts JOIN compagnies WHERE contacts.company_id = compagnies.id ORDER BY created_at DESC LIMIT :limit";

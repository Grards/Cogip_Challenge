...
<main>
    ...
    <input type="hidden" name="new-contact" value="new-contact-value">
        ...
        <input type="text" id="new-contact__name" name="new-contact__name" min=3 max=50 placeholder="Complete Name " required>
        ...
        <input type="email" id="new-contact__email" name="new-contact__email" min=8 max=50 placeholder="Email "required>

        <label for="new-contact__phone">Phone : </label>
        <input type="tel" id="new-contact__phone" name="new-contact__phone" min=10 max=50 placeholder="Phone Number "required>
